            ...
            <form action="" method="post" id="form-cad-end">
                ...
                <div class="d-flex flex-row form-group">   
                    <div class="col-md-8 col-sm-3 col-lg-8">
                        ...
                        <input type="text" name="complemento" id="complemento" class="form-control" placeholder="Informe o Complemento do Endereço"/>
                    </div>
                    <div class="col-md-4 col-sm-3 col-lg-4">
                ...
                <div class="d-flex flex-row form-group">  
                    <div class="col-md-5 col-sm-3 col-lg-5">
                        ...
                        <input type="text" name="bairro" id="bairro" class="form-control" placeholder="Informe o Bairro"/>
                    </div>
                    <div class="col-md-3 col-sm-3 col-lg-3">
                        <label for="cep" class="col-md-6 control-label">Cep</label>            
                        <input type="text" name="cep" id="cep" class="form-control" onkeypress="$(this).mask('00.000-000')" placeholder="Informe o Cep"/>
                    </div>
                    <div class="col-md-4 col-sm-3 col-lg-4">
                ...
                <div class="d-flex flex-row">  
                    ...
                    <div class="col-md-8 col-sm-3 col-lg-8 alert alert-danger my-2 text-center msgError" role="alert"></div>  
                    <div class="col-md-8 col-sm-3 col-lg-8 alert alert-success my-2 text-center msgSuccess" role="alert"></div>    
                </div>
            </form>
        </div>
    </div>
