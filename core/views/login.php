        ...
        <div class="col-sm-4 offset-sm-4">
            ...
            <form action="?r=logar" method="post">
                <div class="form-group">
                    ...
                    <input type="email" name="email" value="<?php echo isset($email) && !empty($email) ? $email : "" ?>" placeholder="Informe o seu E-mail para Logar no Sistema" class="form-control" >
                </div>
                <div class="form-group">
                    <label for="name">Senha:</label>
                    <input type="password" name="password" value="<?php echo isset($password) && !empty($password) ? $password : "" ?>" placeholder="Informe a sua Senha para Logar no Sistema" class="form-control" >
                </div>
                <div class="form-group">
